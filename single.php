...
get_header();
?>
<div class="layoutSingleColumn layoutSingleColumn--article u-paddingTop50 article--double">
    <article class="h-entry">
        <?php while (have_posts()) : the_post(); ?>
            ...
            <div class="poppy e-content">
                <?php the_content(); ?>
            </div>
            <footer class="article--footer">
                <div class="footerMeta">
                    <time datetime="<?php echo esc_attr(get_the_modified_date('c')); ?>" class="dt-updated"><?php echo human_time_diff(get_the_modified_time('U'), current_time('timestamp')) .  __('ago', 'Jaguar'); ?></time>
                    <span class="p-tags article--tags"><?php the_tags('', '', ''); ?></span>
                </div>
